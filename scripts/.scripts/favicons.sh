#!/bin/bash
#
# A bash script that uses FFMPEG to generate favicons in various sizes from a single PNG image
# including .ico format for browser compatibility.
# It outputs the necessary HTML for easy embedding into your website.
#
# https://gist.github.com/dcryan/0dd2b5197c25b3ad64c44b67e131d12f
